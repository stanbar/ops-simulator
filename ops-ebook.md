...
Thinking (T) Deciding on something that makes sense, works, and gets something done.
Intuition (N) Observing possibilities and connections in the abstract world of what could be.
Sensing (S) Observing facts in the physical world and what has actually happened.
Feeling (F) Deciding on something that is valuable, important, emotional, and is a priority.

## Remeber
- Everyone has 2 Observers (S&N) and 2 Deciders (F&T)
- Everyone has 1 Savior Observer and 1 Savior Decider
- Every Letter gets an Introverted or Extraverted charge (the 8 Functions)
- Every Leter is Feminine or Masculine (the 8 Sexuals)
